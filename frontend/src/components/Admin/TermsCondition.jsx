// src/components/Admin/TermsAndCondition.jsx
import React from 'react';
import user1 from "../../assets/images/userimg2.png";
import { FaUser, FaLock, FaFileAlt, FaCamera } from 'react-icons/fa';
  ...
  return (
    <div className="relative p-16">
      ...
      <div className="relative z-10 mb-8">
        <h1 className="text-3xl font-semibold text-white">Terms & Condition</h1>
      </div>
      ...
      <div className="relative z-10 bg-white shadow-lg rounded-lg p-8 flex" style={{ marginTop: '1rem' }}>
        ...
        <div className="flex flex-col items-center w-1/4 border-r pr-8">
          ...
          <nav className="w-full space-y-4 mt-4">
            ...
            <a href="/termsCondition" className="flex items-center p-3 rounded-lg bg-gray-100 side-text-color">
              <FaFileAlt className="mr-3" />
              <span>Terms & Condition</span>
            </a>
            <a href="/policyPrivacy" className="flex items-center p-2 rounded-lg bg-gray-100 side-text-color">
        ...
        {/* Right Side: Terms & Condition Content */}
        <div className="w-3/4 pl-8">
          <div className="mb-6">
            <h3 className="text-xl font-semibold">Terms & Condition</h3>
